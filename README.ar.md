<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 103" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 103｜تركيب تجريدي نابض

### يختزل الصورة في مساحات لونية حية وتركيب خشن وفراغ فني
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 103 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

غالباً ما تحتوي الصورة على تفاصيل أكثر مما يحتاجه الملصق. يحتفظ **Panel 103** بالمشهد الواقعي، ثم يختزل حدوده وعلاقاته ومزاجه الأشد رسوخاً في الذاكرة إلى مساحات لونية حية وخطوط يدوية وتركيب تجريدي يتنفس. تصبح النتيجة أخف وأوضح من دون أن تفقد الجوهر العاطفي للمشهد الأصلي.

### مناسب لـ

- توضيح صورة مزدحمة بصرياً عبر اختزالها إلى أشكال وعلاقات قليلة وقوية؛
- صنع تصميم تجريدي يظل مرتبطاً بوضوح بالعنصر الأصلي؛
- استخدام لون حي ومريح من دون رماد متّسخ أو مظهر سكّري رخيص؛
- ملصقات فنية ونشر مستقل ورسوم معارض وأغلفة وخلفيات ونسب متعددة ومعالجة المجلدات؛

### بداية سريعة

> استخدم XXD Panel 103 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** مساحات تجريدية كبيرة · كولاج خشن · انزياح يدوي · لون حي مشتق من الأصل · فراغ تحريري · حروف متكيفة
...
|---|---|
| **الناتج** | ملصق تحريري تجريدي تجمعه مساحات لونية حية وتركيب خشن وتخطيط احترافي وفراغ فني |
| **البصمة الواضحة** | مساحات غير منتظمة، حواف قص، خطوط يدوية متفاوتة، تراكب منزاح، فراغ أبيض دافئ، ونص قليل |
| **احترام المصدر** | يحفظ الهوية والوضع والعلاقات والجو والألوان المشتقة من الأصل ولا يستبدل السرد الجوهري |
| **الاستخدامات** | النشر المستقل وملصقات المعارض والأغلفة الفنية والمحتوى الاجتماعي والتصميم المستقل والنسب والخلفيات |
<!-- xxd-panel-benefit:end -->

## منطق التحويل

```text
تحديد الموضوع والعلاقات الأشد رسوخاً → حذف المشهد الكامل والتفاصيل الزائدة → الاختزال إلى مساحات لونية وحدود قليلة → إعادة البناء بالانزياح والتراكب والاقتطاع والفراغ → تفتيح أكثر ألوان الأصل حيوية → إكمال الإيقاع بنص تحريري قليل
```

## سمات النتيجة النهائية

- تتجنب المساحات الكبيرة الرسم الواقعي، لكنها تحفظ روح الأصل عبر الحدود والوضع والعلاقات.
- تصنع حواف القص والخطوط اليدوية المتفاوتة والتغطية الجزئية والفجوات والانزياح عفوية مضبوطة.
- لا يظهر أزرق السماء أو الفيروزي أو الأخضر الغض أو الأصفر الدافئ أو المرجاني أو الخوخي إلا إذا استُنتج طبيعياً من الأصل، ويوازنه فراغ أبيض دافئ.
- يحافظ مركز الثقل والأشكال الموجبة والسالبة والكثافة والفراغ على اتزان احترافي داخل مظهر عفوي.
- تقع الحروف بين العنوان اليدوي والتصميم التحريري الحديث؛ تجنّب الرسم الواقعي والخلفيات الكاملة والكرتون والقوالب والمظهر الحاسوبي القوي.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-103-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 103. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-103 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-103 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-103 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-103 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-103 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 103 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-103 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-103`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-103-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-103-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ103 على موجّهه الأصلي ومنطقه الجمالي المستقل. يعرض الجدول روابط جميع المشاريع وخصائص أسلوبها الأساسية، مع تمييز المشروع الحالي بخط عريض.
...
| **[xxd-panel-103](https://github.com/nevertoday/xxd-panel-103)** | تركيب تجريدي نابض · مساحات لونية كبيرة غير منتظمة · عفوية خشنة · خطوط يدوية · تخطيط احترافي · فراغ فني |
...
### القيادة العامة لـ Xiaoxiaodong · Skill القائد العام · 103 يوان صيني

تمنحك دفعة واحدة قدرها 103 يوان صيني Skill القائد العام لهذه السلسلة (`xxd-panel-all`) لإدارة جميع Skills الجنود والتوصية بها واستدعائها وتنسيق العمل الدفعي. اكتب «Skill القائد العام» في رسالة WeChat.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–103) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
